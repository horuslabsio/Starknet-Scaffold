...
//       name: "Starknet Hardhat plugin",
//       description:
//         "Plugin for integrating Starknet tools into Hardhat projects.",
//       status: "Up to date",
...
export default function Page() {
  ...
  return (
    <div className="min-h-[100vh] h-fit w-full  bg-white relative font-coolvetica">
      <div className="w-full bg-primaryGradient py-[30px] px-[100px]">
        ...
        <div className="relative w-fit mx-auto">
          <input
            type="text"
            className="py-5 text-xl leading-[30px] px-6 pl-[60px] bg-[#F7F7F7] text-[
              #7A7A7A] rounded-2xl w-[800px] font-coolvetica"
      ...
      <div className="w-full h-full text-black grid grid-cols-[315px_1fr] gap-y-[54px] pt-8 px-8 pb-[74px]">
        <Filter
          field="category"
          options={[
